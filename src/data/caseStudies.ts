...
export const CASE_STUDIES: CaseStudySource[] = [
  ...
  },
  {
    ...
    methodChecklist: {
      title: {
        en: 'How to replicate it in your business',
        es: 'Cómo replicarlo en tu negocio',
      },
      intro: {
        en: "There's no algorithm trick. There's a system. These are the six things we audit before publishing the first video — the same six we applied on Perreando HotDog. You can check them today without hiring us.",
      ...
      items: [
        {
          threshold: { en: '3 weeks', es: '3 semanas' },
          title: { en: 'One format, not five', es: 'Un formato, no cinco' },
          body: {
            en: 'Most people post on six formats at once and learn nothing from any of them. Pick one, stick with it for three weeks, and only then diversify.',
        ...
        {
          threshold: { en: 'Second 0', es: 'Segundo 0' },
          title: { en: 'The product comes first', es: 'El producto primero' },
          body: {
            en: "In food, you don't build suspense — the product shows up in the first frame. An intro, a logo, or a greeting in the first two seconds is lost audience.",
        ...
        {
          threshold: { en: '50%', es: '50%' },
          title: { en: 'Retention before anything else', es: 'Retención antes que nada' },
          body: {
            en: 'If fewer than half make it past the third second, the problem is the hook. Not the algorithm, not the posting time, not the hashtag.',
        ...
        {
          threshold: { en: '90 days', es: '90 días' },
          title: { en: 'A cadence that holds up', es: 'Cadencia que aguante' },
          body: {
            en: 'Ten videos in one week and then silence kills more accounts than posting too little. Set the frequency you can sustain on your worst week, not your best one.',
        ...
        {
          threshold: { en: '$0', es: '$0' },
          title: { en: 'Zero ads until you have signal', es: 'Cero ads hasta tener señal' },
          body: {
            en: "Paying to distribute content that doesn't retain viewers just buys the same failure faster. First a video proves it works organically — then you amplify it.",
        ...
        {
          threshold: { en: '1 tap', es: '1 tap' },
          title: { en: 'One clear destination', es: 'Un destino claro' },
          body: {
            en: "292K views are worthless if your profile doesn't say where you are, when you're open, and how to order. Traffic with no destination is vanity.",
    ...
    leadCapture: {
      heading: { en: 'The six points, on one page', es: 'Los seis puntos, en una hoja' },
      body: {
        en: "We'll send you the full checklist as a PDF, with the exact criteria to mark each point as passed or not, plus the next case study when it's out. One case a month. No twelve-email sequences.",
      ...
      formEyebrow: { en: '6-point checklist', es: 'Checklist de 6 puntos' },
      formSubtitle: { en: 'One-page PDF, printable', es: 'PDF de una página, imprimible' },
      emailLabel: { en: 'Your email', es: 'Tu correo' },
      emailPlaceholder: { en: 'name@yourbusiness.com', es: 'nombre@tunegocio.com' },
      submitLabel: { en: 'Send it to me', es: 'Enviármelo' },
      successMessage: { en: 'Done. Check your email.', es: 'Listo. Revisa tu correo.' },
      errorFallback: {
        en: "The checklist service isn't set up yet — email us at info@astrattaagency.com and we'll send it straight to you.",
        es: 'El servicio del checklist aún no está configurado — escríbenos a info@astrattaagency.com y te lo enviamos directo.',
      },
      scheduleQuestion: {
        en: 'Would you rather go through it together?',
        es: '¿Prefieres que lo revisemos juntos?',
      },
      scheduleCta: { en: 'Book a 20-min diagnostic', es: 'Agendar diagnóstico de 20 min' },
    },
