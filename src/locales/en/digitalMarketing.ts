export const digitalMarketing = {
  ...
  heading: 'Traffic without leads is just noise.',
  intro:
  ...
  subServices: [
    ...
    },
    {
      slug: 'paid-ads',
      title: 'Paid Ads',
      description: 'Meta and Google campaigns built to hit a cost-per-lead target, not just an impression count.',
  ...
  howFitEyebrow: 'How these fit together',
  howFitText:
    "Social Media builds an audience and warms up cold traffic. Paid Ads turns budget into qualified clicks on a cost-per-lead basis. Lead Generation System combines both with a landing page, lead magnet, and CRM follow-up into one measured pipeline — it's the right starting point if your main goal is a predictable number of qualified leads per month, not just more traffic or more followers.",
  faqs: [
    {
