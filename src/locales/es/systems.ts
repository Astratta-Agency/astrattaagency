import type { systems as en } from '@/locales/en/systems'
...
export const systems: typeof en = {
  ...
  ctaSecondary: 'Ver qué incluye cada nivel',
  insideEyebrow: 'Qué hay adentro',
  matrixEyebrow: 'Los cuatro niveles',
  matrixNote:
    'El presupuesto de anuncios siempre lo pagas tú, directo a Meta y Google, desde tu propia cuenta. Nosotros la gestionamos. Nunca la tocamos.',
  faqEyebrow: 'FAQ',
}
